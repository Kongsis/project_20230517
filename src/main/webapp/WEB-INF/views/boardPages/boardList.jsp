        ...
        <c:forEach items="${boardList}" var="board">
            <div class="card" style="flex: 1; margin: 10px;">
                <c:if test="${board.fileAttached == 1}">
                    <img src="${pageContext.request.contextPath}/upload/${board.storedFileName}" width="50"
                         height="50">
                </c:if>
                <h1><a href="/board/detail?id=+${board.id}&page=${paging.page}&q=${q}&type=${type}"> ${board.boardTitle}</a></h1>
                <p class="price">${String.format("%,d", board.boardPrice)}원</p>
